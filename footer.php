...
<footer class="site-footer bg-black text-white mt-auto border-t-8 border-black">
      ...
      <div class="flex items-center gap-4">
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="flex items-center gap-3 no-underline">
          <div class="flex items-center">
            <span class="w-4 h-4 rounded-full bg-[var(--color-red)] border-2 border-white"></span>
            <span class="w-4 h-4 bg-[var(--color-yellow)] -ml-1 border-2 border-white"></span>
        ...
        <span class="opacity-70">&copy; <?php echo esc_html( date( 'Y' ) ); ?> <?php bloginfo( 'name' ); ?></span>
      </div>
